import unittest
from datasets.GPT_4.Few_shot1.programs.program_073 import *
...
class TestVersion(unittest.TestCase):
    ...
    def test_reverse_vowels_only_vowels(self): self.assertEqual(reverse_vowels("aeiou"), "uoiea")
    ...
    def test_reverse_vowels_single_char_vowel(self): self.assertEqual(reverse_vowels("a"), "a")

    def test_reverse_vowels_single_char_consonant(self): self.assertEqual(reverse_vowels("b"), "b")

    def test_reverse_vowels_with_spaces(self): self.assertEqual(reverse_vowels("a e i o u"), "u o i e a")

    def test_reverse_vowels_mixed_content(self): self.assertEqual(reverse_vowels("ThIs Is A tEst"), "ThEs As I tIst")
