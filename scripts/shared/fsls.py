"""
This script analyzes and visualizes mutation testing results from 3 reruns of the 'fsl' experiment.
It loads data from three CSVs ('appendix_metrics_table_fslF.csv', 'appendix_metrics_table_fsl1.csv', 'appendix_metrics_table_fsl2.csv')
...
# PATHS
base_dir = "results"
fsl_plots_path = os.path.join(base_dir, 'plots_fsl')
metrics_tables_csvs = [
...
if "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot1_pie_meanfsl.png"))
    plt.close()
    print("Pie plot saved as plot1_pie_meanfsl.png")
else:
...
if "Mutation Score" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot2_boxplot_mean_fsl.png"))
    plt.close()
    print("Boxplot done (plot2_boxplot_mean_fsl.png)")
...
plt.tight_layout()
plt.savefig(os.path.join(fsl_plots_path, "plot4_barplot_meanfsl.png"))
plt.close()
print("PLOT 4 saved as plot4_barplot_meanfsl.png")
...
if "Statement Coverage (%)" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot7_mean_mutscore_vs_mean_coveragefsl.png"))
    plt.close()
    print("PLOT 7 saved as plot7_mean_mutscore_vs_mean_coveragefsl.png")
...
if "Assertion Count" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.legend(handles=legend_elements)
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot8_mean_mutscore_vs_mean_assertioncountfsl.png"))
    plt.close()
    print("PLOT 8 saved as plot8_mean_mutscore_vs_mean_assertioncountfsl.png")
...
if "Test Suite Size" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.legend(handles=legend_elements)
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot10_mean_mutscore_vs_mean_suitesizefsl.png"))
    plt.close()
    print("PLOT 10 saved as plot10_mean_mutscore_vs_mean_suitesizefsl.png")
...
if "Assertion Count" in agg_data.columns and "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot12_mean_assertioncount_fsl.png"))
    plt.close()
    print("PLOT 12 saved as plot12_mean_assertioncount_fsl.png")
else:
...
if "Test Time (s)" in agg_data.columns and "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(fsl_plots_path, "plot14_mean_totaltime_fsl.png"))
    plt.close()
    print("PLOT 14 saved as plot14_mean_totaltime_fsl.png")
else:
    print("Required columns for Plot 14 not found.")

print("All selected plots saved in folder:", fsl_plots_path)
