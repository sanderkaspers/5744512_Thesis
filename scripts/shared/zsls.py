"""
This script analyzes and visualizes mutation testing results from 3 reruns of the 'zsl' experiment.
It loads data from three CSVs ('appendix_metrics_table_zslF.csv', 'appendix_metrics_table_zsl1.csv', 'appendix_metrics_table_zsl2.csv')
...
# PATHS
base_dir = "results"
zsl_plots_path = os.path.join(base_dir, 'plots_zsl')
metrics_tables_csvs = [
...
if "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot1_pie_meanzsl.png"))
    plt.close()
    print("Pie plot saved as plot1_pie_meanzsl.png")
else:
...
if "Mutation Score" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot2_boxplot_mean_zsl.png"))
    plt.close()
    print("Boxplot done (plot2_boxplot_mean_zsl.png)")
...
plt.tight_layout()
plt.savefig(os.path.join(zsl_plots_path, "plot4_barplot_meanzsl.png"))
plt.close()
print("PLOT 4 saved as plot4_barplot_meanzsl.png")
...
if "Statement Coverage (%)" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot7_mean_mutscore_vs_mean_coveragezsl.png"))
    plt.close()
    print("PLOT 7 saved as plot7_mean_mutscore_vs_mean_coveragezsl.png")
...
if "Assertion Count" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.legend(handles=legend_elements)
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot8_mean_mutscore_vs_mean_assertioncountzsl.png"))
    plt.close()
    print("PLOT 8 saved as plot8_mean_mutscore_vs_mean_assertioncountzsl.png")
...
if "Test Suite Size" in agg_data.columns and "Mutation Score" in agg_data.columns:
    ...
    plt.legend(handles=legend_elements)
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot10_mean_mutscore_vs_mean_suitesizezsl.png"))
    plt.close()
    print("PLOT 10 saved as plot10_mean_mutscore_vs_mean_suitesizezsl.png")
...
if "Assertion Count" in agg_data.columns and "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot12_mean_assertioncount_zsl.png"))
    plt.close()
    print("PLOT 12 saved as plot12_mean_assertioncount_zsl.png")
else:
...
if "Test Time (s)" in agg_data.columns and "Detailed Classification" in agg_data.columns:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(zsl_plots_path, "plot14_mean_totaltime_zsl.png"))
    plt.close()
    print("PLOT 14 saved as plot14_mean_totaltime_zsl.png")
else:
    print("Required columns for Plot 14 not found.")

print("All selected plots saved in folder:", zsl_plots_path)
