...
# PATHS
cot1_input_folder = "results/cot1/filtered_mutation_results"
print("Set input folder for YAML files:", cot1_input_folder)
csv_path_output = "results/cot1/classification_summary_cot1.csv"
...
print("Checking if input folder exists:", cot1_input_folder)
if os.path.exists(cot1_input_folder):
    folder_check_present = True
    print("Input folder present:", cot1_input_folder)
else:
    print("Input folder not found:", cot1_input_folder)
    print("ERROR: Input folder must exist or the script cannot continue.")
    assert os.path.exists(cot1_input_folder)

# List files
print("Reading files from the input folder...")
for file_x in os.listdir(cot1_input_folder):
...
for y_file in yaml_file_list:
    ...
    try:
        full_path = cot1_input_folder + "/" + y_file
