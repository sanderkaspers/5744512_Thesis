...
input_json_path = "results/cot1/filtered_tests_cot1.json"
python_mutpy_path = ".venv38/Scripts/python.exe"
mutation_output_dir = 'results/cot1/filtered_mutation_results'
logs_dir = os.path.join(mutation_output_dir, 'logs')
FILTERED_JSON_FILENAME = input_json_path
test_module_path = "datasets.GPT_4.Chain_of_thought1.tests"
cot1_programs_path = "datasets.GPT_4.Chain_of_thought1.programs"
EXTRA_LOGS_ON = True
...
for tn in all_test_names_list:
    try:
        ...
        program_module_name = cot1_programs_path + ".program_" + str(test_name_index_value).zfill(3)
