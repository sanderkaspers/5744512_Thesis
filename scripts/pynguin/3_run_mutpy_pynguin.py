...
input_json_path = "results/pynguin/filtered_tests_pynguin.json"
python_mutpy_path = ".venv38/Scripts/python.exe"
mutation_output_dir = 'results/pynguin/filtered_mutation_results'
logs_dir = os.path.join(mutation_output_dir, 'logs')
FILTERED_JSON_FILENAME = input_json_path
test_module_path = "datasets.pynguin.tests"
pynguin_programs_path = "datasets.pynguin.programs"
EXTRA_LOGS_ON = True
...
for tn in all_test_names_list:
    try:
        ...
        program_module_name = pynguin_programs_path + ".program_" + str(test_name_index_value).zfill(3)
