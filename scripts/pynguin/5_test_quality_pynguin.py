...
# PATHS
pynguin_input_folder = "results/pynguin/filtered_mutation_results"
print("Set input folder for YAML files:", pynguin_input_folder)
csv_path_output = "results/pynguin/classification_summary_pynguin.csv"
...
print("Checking if input folder exists:", pynguin_input_folder)
if os.path.exists(pynguin_input_folder):
    folder_check_present = True
    print("Input folder present:", pynguin_input_folder)
else:
    print("Input folder not found:", pynguin_input_folder)
    print("ERROR: Input folder must exist or the script cannot continue.")
    assert os.path.exists(pynguin_input_folder)

# List files
print("Reading files from the input folder...")
for file_x in os.listdir(pynguin_input_folder):
...
for y_file in yaml_file_list:
    ...
    try:
        full_path = pynguin_input_folder + "/" + y_file
