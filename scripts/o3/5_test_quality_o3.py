...
# PATHS
o3_input_folder = "results/o3/filtered_mutation_results"
print("Set input folder for YAML files:", o3_input_folder)
csv_path_output = "results/o3/classification_summary_o3.csv"
...
print("Checking if input folder exists:", o3_input_folder)
if os.path.exists(o3_input_folder):
    folder_check_present = True
    print("Input folder present:", o3_input_folder)
else:
    print("Input folder not found:", o3_input_folder)
    print("ERROR: Input folder must exist or the script cannot continue.")
    assert os.path.exists(o3_input_folder)

# List files
print("Reading files from the input folder...")
for file_x in os.listdir(o3_input_folder):
...
for y_file in yaml_file_list:
    ...
    try:
        full_path = o3_input_folder + "/" + y_file
