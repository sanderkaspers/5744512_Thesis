...
test_data_path = "datasets/o3/tests"
filtered_path = "datasets/o3//filtered_tests"
o3_result_dir = "results/o3"
LOG_FILE_FINAL_v2 = "results/o3/validation_log.txt"
JSON_NAME_X = "results/o3/filtered_tests_o3.json"
...
try:
    ...
    if not os.path.exists(o3_result_dir):
        print("Result folder (o3) does not exist, creating...")
        os.makedirs(o3_result_dir)
        print("Result folder (o3) created.")
    else:
        print("Result folder (o3) already exists.")
...
while idx_now <= total_tests_so_far:
    ...
    cov = coverage.Coverage(source=["datasets/o3/programs"])
    try:
        cov.start()
...
cov_outpath = "results/o3/coverage_per_test_o3.json"
try:
...
manual_check_file = "results/o3/manual_checklist.txt"
try:
    ...
    for man_test in manual_checklist:
        ...
        program_path = os.path.join("datasets/o3/programs", program_file_name)
        test_file_name = man_test[0] + ".py"
        test_file_path = os.path.join("datasets/o3/tests", test_file_name)
