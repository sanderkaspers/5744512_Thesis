...
# PATHS
out_dir_o3 = "results/o3/filtered_mutation_results"
result_csv_path = os.path.join(out_dir_o3, "mutation_summary_o3.csv")
debug_log_file = os.path.join(out_dir_o3, "report_debug_log.txt")
...
if not os.path.exists(out_dir_o3):
    os.makedirs(out_dir_o3, exist_ok=True)
    print("Output directory created:", out_dir_o3)
else:
    print("Output directory already exists:", out_dir_o3)
